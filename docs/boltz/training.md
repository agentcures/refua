...
data:
  datasets:
    - _target_: refua.boltz.data.module.training.DatasetConfig
...
```yaml
  datasets:
    - _target_: refua.boltz.data.module.training.DatasetConfig
      ...
      prob: 0.5
      sampler:
        _target_: refua.boltz.data.sample.cluster.ClusterSampler
      cropper:
        _target_: refua.boltz.data.crop.boltz.BoltzCropper
        min_neighborhood: 0
        max_neighborhood: 40
