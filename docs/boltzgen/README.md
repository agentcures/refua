...
### 4 - Install Refua (includes BoltzGen)

Run the command below to install Refua from PyPI:

```bash
pip install refua
```

Alternatively, if you prefer to install an editable, locally-managed copy, download this repository, change directory into it, and install from source:
...
- `--config_dir CONFIG_DIR` - Path to the directory of default config files. Default: `src/refua/boltzgen/resources/config`
...
|-------------|---------|-----------------|
| `src/refua/boltzgen/resources/config/train/boltzgen_small.yaml` | Train the **small** Boltzgen model (recommended for development, 8 GPUs, gradient accumulation 16) | `python src/refua/boltzgen/resources/main.py src/refua/boltzgen/resources/config/train/boltzgen_small.yaml  name=boltzgen_small` |
| `src/refua/boltzgen/resources/config/train/boltzgen.yaml` | Train the **large** BoltzGen model | `python src/refua/boltzgen/resources/main.py src/refua/boltzgen/resources/config/train/boltzgen.yaml        name=boltzgen_large` |
| `src/refua/boltzgen/resources/config/train/inverse_folding.yaml` | Train the **inverse-folding** model only | `python src/refua/boltzgen/resources/main.py src/refua/boltzgen/resources/config/train/inverse_folding.yaml name=boltzgen_if` |
...
python src/refua/boltzgen/resources/main.py src/refua/boltzgen/resources/config/train/boltzgen_small.yaml \
       name=boltzgen_small
```
...
```bash
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 \
python src/refua/boltzgen/resources/main.py src/refua/boltzgen/resources/config/train/boltzgen.yaml \
       name=boltzgen_large
```
...
```bash
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 \
python src/refua/boltzgen/resources/main.py src/refua/boltzgen/resources/config/train/inverse_folding.yaml \
       name=boltzgen_if
```
