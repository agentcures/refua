...
class Boltz2(LightningModule):
    ...
    def __init__(
        ...
        affinity_model_args: dict[str, Any] | None = None,
        affinity_model_args1: dict[str, Any] | None = None,
        affinity_model_args2: dict[str, Any] | None = None,
        validators: Any = None,
        ...
        diffusion_kwargs = {
            ...
            if key in inspect.signature(AtomDiffusion).parameters
        }
