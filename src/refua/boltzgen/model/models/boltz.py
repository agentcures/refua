...
class Boltz(LightningModule):
    ...
    def __init__(
        ...
        step_scale_schedule: list[dict[str, float]] | None = None,
        noise_scale_schedule: list[dict[str, float]] | None = None,
        ...
        token_distance_args: dict | None = None,
        ...
        inverse_fold_args: dict[str, Any] | None = None,
    ...
    def predict_step(
        ...
        try:
            ...
            if (
                self.predict_args.get("return_z_feats")
            ):
