...
class Analyze(Task):
    ...
    def aggregate_metrics(self):
        ...
        for sample_id in tqdm(
            sample_ids, desc="Loading saved metrics from disk. 1% of total"
        ):
            data = np.load(
    ...
    def run_foldseek_clustering(self, df: pd.DataFrame, suffix=None) -> pd.DataFrame:
        ...
        try:
            ...
            msg = "Structure clustering was unsuccessful. No cluster labels are added to the dataframe / csv file output."
            print(msg)
        return df
