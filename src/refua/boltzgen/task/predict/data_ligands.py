...
class PredictionDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx: int) -> dict:
        ...
        try:
            ...
            print(f"Failed to load input for {target_id}  with error {e}. Skipping.")
        ...
        try:
            ...
            print(f"Tokenizer failed on {target_id} with error {e}. Skipping.")
            return self.__getitem__(0)
        ...
        try:
            ...
            print(f"Featurizer failed on {target_id} with error {e}. Skipping.")
            return self.__getitem__(0)
