...
from boltzgen.data.data import MSA, Input, Record, Structure
...
class PredictionDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx: int) -> dict:
        ...
        if self.dataset.chain_ids is not None:
        ...
        try:
            ...
            print(f"Failed to load input for {pdb_id} with error {e}. Skipping.")
        ...
        try:
            ...
            print(f"Tokenizer failed on {pdb_id} with error {e}. Skipping.")
            return self.__getitem__(0)
        ...
        try:
            ...
            print(f"Featurizer failed on {pdb_id} with error {e}. Skipping.")
            return self.__getitem__(0)
