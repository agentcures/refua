...
from boltzgen.utils.resources import read_optional_resource_json
...
class Filter(Task):
    ...
    **Diversity.** A lazy-greedy selection chooses `div_budget` designs maximizing:
    ...
    def absolute_metrics(self):
        """Apply normalized and weighted metrics when stats are available."""
        norm_stats = read_optional_resource_json("metrics_normalization.json")
    ...
    def write_outdir(self):
        ...
        self.df.to_csv(self.outdir / "all_designs_metrics.csv", index=False)
    ...
    def make_visualization(
        ...
        pdf_path = self.outdir / "results_overview.pdf"
