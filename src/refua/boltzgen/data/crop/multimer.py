...
from boltzgen.data.data import TokenBond, Tokenized
...
class MultimerCropper(Cropper):
    ...
    def crop(
        ...
        initial_crop: list[int] | None = None,
        prefer_protein_queries: bool | None = False,
    ) -> Tokenized:
    ...
    def select_cropped_indices(
        ...
        initial_crop: np.ndarray | None = None,
    ):
