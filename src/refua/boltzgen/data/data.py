...
class PubChem:
    ...
    smiles: list[str]
    mols: list[Mol] = None
    protein_cluster_03: str | None = None
    protein_cluster_06: str | None = None
    protein_cluster_09: str | None = None
...
def numeric_to_string(
    name: tuple[int, int, int, int] | tuple[int, int, int, int, int],
) -> str:
...
class Structure(NumpySerializable):
    ...
    def _from_feat(
        ...
        res_per_chain = dict.fromkeys(np.unique(asym_id), 0)
...
class ConfidenceInfo:
    ...
    chains_ptm: dict | None = None
    pair_chains_iptm: dict | None = None
...
class Target:
    ...
    templates: dict[str, Structure] | None = None
...
class Tokenized:
    ...
    bonds: np.ndarray
    structure: Structure
    token_to_res: np.ndarray | None = None
